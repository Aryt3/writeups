...
Taking a look at the website I inspect the javascript which is being loaded in the homepage. (https://nvstgt.com/Quantity/static/tic.js)<br/>
```js
...
function myfunc() {
	...
	if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' ||
		...
		document.getElementById('print')
			.innerHTML = "Despite My Best Efforts To The Contrary... It Turns Out I've Won.";
...
Some interesting things we should keep in mind are the following code pieces. <br/>
```js
async function checkCookie(secret) { 
  	let msg = "Despite My Best Efforts To The Contrary... It Turns Out I've Won."; 
	document.cookie = msg;
...
Looking at this we see that we can actually manipulate the `document.cookie` to execute `XSS`. <br/>
