...
Visiting the website I saw a button and a some text. <br/>
```html
<!DOCTYPE html>
<html lang="en">
    <head>
...
Now apparently you had to press the button but looking at the `javascript` code you couldn't do it manually with your mouse or with your `tab` key. <br/>
```html
<button tabindex="-1" id="accept">I Accept</button>
```

For this reason I openend up the console and reloaded the browser window. <br/>
Than I entered the following commands into the console: <br/>
```js
